...
const Navbar = () => {
  return (
    <>
    <div className='flex justify-between gap-20 items-center bg-fuchsia-200  py-1 shadow-md text-md font-mono px-10'>
    
    <NavLink to="/"><h1 className='text-2xl font-bold text-fuchsia-950'>Zare</h1></NavLink>
